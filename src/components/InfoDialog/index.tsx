...
const InfoDialog: FunctionComponent<Props> = ({
    show,
    onClose
}) => {
    const [{
    ...
    return <animated.div style={props} className={style.dialog}>
        {isLoading ? <Loader type="ThreeDots" width={100} height={100} /> :
            <div className={style.dialog__content}>
                ...
                <div className={style.dialog__body}>
                    <div className={style.dialog__image} style={{
