...
const backgroundImagescontext = require.context(
...
export const getInterestingFacts = () =>
    import("assets/data/interestingFacts.json");

export const getMusic = () =>
    import("assets/music/gta-san-adreas-theme-song.mp3") as Promise<Module>;

export const getInfo = async () => {
    const { image: imagePath, description } = await import(
...
export const setSettings = (object: Settings) =>
